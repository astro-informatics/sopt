...
% Weights
w=ones(size(y)); % here we set them to 1 first, need to change later
...
[sol1, z] = sopt_mltb_admm_bpconw(y, epsilon, A, At, Psi, Psit, w, param1);
...
% Solve BPDN problem
[sol2, z] = sopt_mltb_admm_bpconw(y, epsilon, A, At, Psi, Psit, w, param1);
