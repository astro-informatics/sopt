function sol = sopt_admm_rwbpcon(y, epsilon, A, At, Psi, Psit, ...
  paramT, sigma, tol, maxiter, initsol)
% sopt_admm_rwbpcon - Solve reweighted BPCON problem with positivity constraint
%
...
if nargin<11
    ...
    sol = sopt_admm_bpcon(y, epsilon, A, At, Psi, Psit, param);
else
    sol = initsol;
end
